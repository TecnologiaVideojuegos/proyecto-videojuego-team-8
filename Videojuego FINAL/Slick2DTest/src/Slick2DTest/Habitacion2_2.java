...
public class Habitacion2_2 extends BasicGameState {
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
       this.habitacionagujero = new Image("res/habitacion2-2.jpg");
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int i) throws SlickException {
        ...
        if (characterPositionX> 387 && characterPositionX < 500 && entrada.isKeyDown(Input.KEY_J)){
            sbg.enterState(63);
            pasos.stop();
        }
