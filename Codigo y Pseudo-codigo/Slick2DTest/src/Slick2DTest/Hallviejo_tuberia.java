...
public class Hallviejo_tuberia extends BasicGameState{

    private Image tuberia, hall;
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
       ...
       this.tuberia = new Image("res/Tuberia.png");
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int i) throws SlickException {
        ...
        if (characterPositionX>476 && characterPositionX<580&&entrada.isKeyDown(Input.KEY_J)){
            Principal.tuberia = true;
            Principal.characterPositionX8 = characterPositionX;
            Principal.de32a8 = true;
            sbg.enterState(8);
            }
